...
--
-- Host: localhost    Database: dostavka
-- ------------------------------------------------------
...
CREATE TABLE `addreses` (
  ...
  `address_str` char(200) DEFAULT NULL,
  `coord_1` float DEFAULT NULL,
  `coord_2` float DEFAULT NULL
...
CREATE TABLE `orders` (
  ...
  `curier` int(11) DEFAULT NULL,
  `manager` int(11) DEFAULT NULL,
  `start_point` int(11) DEFAULT NULL,
  `finish_point` int(11) DEFAULT NULL,
...
-- Dump completed on 2018-06-19  0:15:15
